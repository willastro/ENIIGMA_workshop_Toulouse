...
def stats_blockt(ntt, new_tau, etau, fileout, filecl, pathdir, f_sig=5):
    ...
    if w_values == 2:
        ...
        int1 = np.linspace(c1-f_sig*c1,c1+f_sig*c1,3000)#np.random.normal(c1, m, 1000)
        int2 = np.linspace(c2-f_sig*c2,c2+f_sig*c2,3000)#np.random.normal(c2, m, 1000)
        ...
        int1 = np.linspace(c1-f_sig*c1,c1+f_sig*c1,3000)
        int2 = np.linspace(c2-f_sig*c2,c2+f_sig*c2,3000)
        int3 = np.linspace(c3-f_sig*c3,c3+f_sig*c3,3000)
        ...
        int1 = np.linspace(c1-f_sig*c1,c1+f_sig*c1,3000)#np.random.normal(c1, m, 1000)
        int2 = np.linspace(c2-f_sig*c2,c2+f_sig*c2,3000)#np.random.normal(c2, m, 1000)
        int3 = np.linspace(c3-f_sig*c3,c3+f_sig*c3,3000)#np.random.normal(c3, m, 1000)
        int4 = np.linspace(c4-f_sig*c4,c4+f_sig*c4,3000)#np.random.normal(c4, m, 1000)
        ...
        for i1, j1, k1, l1 in zip(list2, list2, list2, list2):
            ...
            #p = (1. / (len(ydata0) - 1. - w_values)) * np.sum(((ydata0 - f1) / 0.1*err_y) ** 2)
            #p = (1. / (len(ydata0) - 1. - w_values)) * np.sum(((ydata0 - f1)/(1.0*err_y))**2)
            p = np.sum(((ydata0 - f1)**2)/f1)
            if p > 10000.:
                p = p*0.01
            #print(p)
        ...
        int2 = np.linspace(c2-f_sig*c2,c2+f_sig*c2,3000)#np.random.normal(c2, m, 1000)
        int3 = np.linspace(c3-f_sig*c3,c3+f_sig*c3,3000)#np.random.normal(c3, m, 1000)
        int4 = np.linspace(c4-f_sig*c4,c4+f_sig*c4,3000)
        int5 = np.linspace(c5-f_sig*c5,c5+f_sig*c5,3000)#np.random.normal(c5, m, 1000)
        ...
        int4 = np.linspace(c4-f_sig*c4,c4+f_sig*c4,3000)#np.random.normal(c4, m, 1000)
        int5 = np.linspace(c5-f_sig*c5,c5+f_sig*c5,3000)#np.random.normal(c5, m, 1000)
        int6 = np.linspace(c6-f_sig*c6,c6+f_sig*c6,3000)
        ...
        for i1, j1, k1, l1, m1, n1 in zip(list2, list2, list2, list2, list2, list2):
            ...
            #p = (1. / (len(ydata0) - 1. - w_values)) * np.sum(((ydata0 - f1)/(0.6*err_y))**2)
            p = np.sum(((ydata0 - f1)**2)/f1)
            if p > 10000.:
                p = p*0.01
            #print(p)
        ...
        int5 = np.linspace(c5-f_sig*c5,c5+f_sig*c5,3000)#np.random.normal(c5, m, 1000)
        int6 = np.linspace(c6-f_sig*c6,c6+f_sig*c6,3000)
        int7 = np.linspace(c7-f_sig*c7,c7+f_sig*c7,3000)
        ...
        int6 = np.linspace(c6-f_sig*c6,c6+f_sig*c6,3000)
        int7 = np.linspace(c7-f_sig*c7,c7+f_sig*c7,3000)
        int8 = np.linspace(c8-f_sig*c8,c8+f_sig*c8,3000)
        ...
        for i1, j1, k1, l1, m1, n1, o1, q1 in zip(list2, list2, list2, list2, list2, list2, list2, list2):
            ...
            #p = 0.001*(1. / (len(ydata0) - 1. - w_values)) * np.sum(((ydata0 - f1)/(1*err_y))**2)
            p = np.sum(((ydata0 - f1)**2)/f1)
            #print(p)
            if p > 10000.:
                p = p*0.01
